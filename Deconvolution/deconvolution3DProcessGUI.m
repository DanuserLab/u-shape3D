...
% Last Modified by GUIDE v2.5 16-Jul-2018 21:50:37
...
% handles
handles.text_PSFpath.String = funParams.pathPSF;
...
funParams.pathPSF = handles.text_PSFpath.String;
...
for i =1 : numel(funParams.PerChannelParams)
    ...
    elseif strcmp(paramName,'deconMode')
        parVal = funParams.(paramName)(iChan);
        set(handles.popupmenu_deconMode, 'String', {'weiner','richLucy'},...
        'Value', find(ismember({'weiner','richLucy'},parVal)))
    end
end
...
handles.text_PSFpath.String = fullfile(pathPSF,filePSF);
