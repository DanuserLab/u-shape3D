function meshColor = loadIntensityVertexSurfaceColor(MD, chan, frame)

% loadIntensityVertexSurfaceColor - loads the color of a surface colored by intensity for each image
%
...
meshColor = iStruct.vertexIntensities.mean;
