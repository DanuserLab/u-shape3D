...
% Last Modified by GUIDE v2.5 29-Jul-2019 17:18:31
...
userData.meshModeOptions = Mesh3DProcess.validMeshModes; %{'otsu', 'otsuMulticell', 'otsuSteerable', 'twoLevelSurface', 'threeLevelSurface'};
userData.smoothMeshModeOptions = Mesh3DProcess.validSmoothMeshModes; %{'curvature', 'none'};
userData.registrationModeOptions = Mesh3DProcess.validRegistrationModes;
...
for i =1 : numel(funParams.PerChannelParams)
    ...
    if ~strcmp(paramName,'meshMode') && ~strcmp(paramName,'smoothMeshMode') && ... 
            ~strcmp(paramName,'filterScales') &&  ~strcmp(paramName,'registrationMode') && ...
        ~isempty(funParams.(paramName))  && ~any(ismember(Mesh3DProcess.guiIgnoreParameters, paramName))      
%         if ~any(ismember(Mesh3DProcess.guiIgnoreParameters, paramName))      
            ...
            elseif iscell(funParams.(paramName)) && ~isempty(parVal{:}) 
...
%         end
    ...
    elseif strcmp(paramName,'registrationMode')
        parVal = funParams.(paramName)(iChan);
        set(handles.popupmenu_registrationMode, 'String', userData.registrationModeOptions,...
        'Value', find(ismember(userData.registrationModeOptions, parVal)))
    end
end
...
for i =1 : numel(funParams.PerChannelParams)
    ...
    elseif strcmp(paramName,'smoothMeshMode')
        ...
        funParams.(paramName)(iChan) = strSet(val);
    elseif strcmp(paramName,'registrationMode')
        strSet = handles.popupmenu_registrationMode.String;
        val = handles.popupmenu_registrationMode.Value;
        funParams.(paramName)(iChan) = strSet(val);        
    elseif strcmp(paramName,'filterScales')
...
% --- Executes on selection change in popupmenu_registrationMode.
function popupmenu_registrationMode_Callback(hObject, eventdata, handles)
% hObject    handle to popupmenu_registrationMode (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hints: contents = cellstr(get(hObject,'String')) returns popupmenu_registrationMode contents as cell array
%        contents{get(hObject,'Value')} returns selected item from popupmenu_registrationMode


% --- Executes during object creation, after setting all properties.
function popupmenu_registrationMode_CreateFcn(hObject, eventdata, handles)
% hObject    handle to popupmenu_registrationMode (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
...
% --- Executes on button press in edit_saveRawImages.
function edit_saveRawImages_Callback(hObject, eventdata, handles)
% hObject    handle to edit_saveRawImages (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hint: get(hObject,'Value') returns toggle state of edit_saveRawImages


% --- Executes on button press in edit_saveCurvatureImage.
function edit_saveCurvatureImage_Callback(hObject, eventdata, handles)
% hObject    handle to edit_saveCurvatureImage (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hint: get(hObject,'Value') returns toggle state of edit_saveCurvatureImage


% --- Executes on button press in edit_saveEdgeImage.
function edit_saveEdgeImage_Callback(hObject, eventdata, handles)
% hObject    handle to edit_saveEdgeImage (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hint: get(hObject,'Value') returns toggle state of edit_saveEdgeImage


% --- Executes on button press in edit_saveRawSubtractedImages.
function edit_saveRawSubtractedImages_Callback(hObject, eventdata, handles)
% hObject    handle to edit_saveRawSubtractedImages (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hint: get(hObject,'Value') returns toggle state of edit_saveRawSubtractedImages
