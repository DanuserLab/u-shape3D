function meshColor = loadSegmentSurfaceInterTriangleColor(MD, chan, frame, colorKey, surfaceSegmentInterIter)

% loadSegmentSurfaceInterTriangleColor - loads the color of a mesh surface colored by intermediate segmentation, triangle
%
...
sSegment = bStruct.surfaceSegmentIntermediate.triangle{surfaceSegmentInterIter};
